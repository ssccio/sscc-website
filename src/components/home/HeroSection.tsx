...
export function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden industrial-texture">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-background">
        <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-primary/8 rounded-full blur-[100px]" />
        <div className="absolute bottom-1/4 right-1/3 w-[400px] h-[400px] bg-primary/5 rounded-full blur-[80px]" />
      </div>

      {/* Floating Icons - Industrial feel */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-24 left-[15%] animate-float opacity-15">
          <Server className="w-14 h-14 text-primary" />
        </div>
        <div className="absolute top-40 right-[18%] animate-float delay-500 opacity-15">
          <Database className="w-12 h-12 text-primary" />
        </div>
        <div className="absolute bottom-36 left-[22%] animate-float delay-1000 opacity-15">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-primary/10 border border-primary/25 text-primary text-sm font-medium mb-8 animate-fade-in">
